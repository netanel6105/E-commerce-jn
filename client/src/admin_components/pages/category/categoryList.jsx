...
const CategoryList = () => {
  ...
  const doApi = async() =>{
    ...
    try {
      let url = `${API_URL}/categories?page=${page}&perPage=${perPage}`;
  ...
  return (
    ...
    <div className='bg-gray-800 flex p-4'>
      ...
      <div >
      <NavLink className="bg-blue-400 rounded-md py-2 px-2 font-medium"  to= '/admin/category/new'>  Add New Category </NavLink>
      </div>
    
      <div className='ml-96'>
         <Pagination apiPages={API_URL+"/categories/count?perPage=5"}
          linkTo={"/admin/category?page="}
    ...
    <table className="w-full border-collapse bg-white text-left text-sm text-gray-500">
      <thead className="bg-gray-50">
        <tr>
          ...
          <th scope="col" className="px-6 py-4 font-medium text-gray-900">category_id</th>
